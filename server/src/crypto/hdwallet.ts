...
export interface WalletKeyPair {
  ...
  privateKey: string;  // hex-encoded private key (only for master holder)
  address: string;     // derived address identifier (hash of pubkey)
}
 ...
 */
export function verifyAddressBelongsToMaster(
  xpub: string,
 ...
 * Uses scrypt-based key derivation + AES-256-CBC.
